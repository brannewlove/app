...
-- Generated on: 2026. 1. 21. 오전 9:52:36
...
) ENGINE = InnoDB AUTO_INCREMENT = 3848 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
) ENGINE = InnoDB AUTO_INCREMENT = 87 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '반납 자산 테이블';
...
CREATE TABLE `trade` (
    ...
    KEY `idx_cj_id` (`cj_id`),
    KEY `idx_timestamp` (`timestamp`)
) ENGINE = InnoDB AUTO_INCREMENT = 47 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '거래/작업 기록 테이블';
...
) ENGINE = InnoDB AUTO_INCREMENT = 5413 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

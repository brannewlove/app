...
-- Generated on: 2026. 1. 28. 오후 10:57:19
...
) ENGINE = InnoDB AUTO_INCREMENT = 3879 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `confirmed_assets` (
    ...
    KEY `idx_cj_id` (`cj_id`)
) ENGINE = InnoDB AUTO_INCREMENT = 123 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '사용자 변경 확인 테이블';
...
) ENGINE = InnoDB AUTO_INCREMENT = 95 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '반납 자산 테이블';
...
CREATE TABLE `trade` (
    ...
    KEY `idx_cj_id` (`cj_id`),
    KEY `idx_timestamp` (`timestamp`)
) ENGINE = InnoDB AUTO_INCREMENT = 137 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '거래/작업 기록 테이블';
